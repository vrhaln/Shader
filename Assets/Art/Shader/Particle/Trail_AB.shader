...
Shader "ASE/Particle/Trail_AB"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float mulTime21 = _Time.y * ( _TimeScale * ( 1.0 - ( ( ( _TimeScaleoverLifetimeStrength * i.vertexColor.a ) * 0.1 ) + 0.0001 ) ) );
			...
			float saferPower65 = max( u25 , 0.0001 );
			float clampResult28 = clamp( ( i.uv_texcoord.y * ( 1.0 - i.uv_texcoord.y ) * ( 1.0 - u25 ) * (pow( saferPower65 , 0.41 )*1.0 + -0.1) * 16.5 ) , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=18100
-1048;171;1048;708;3954.944;-289.2913;1.372545;True;False
Node;AmplifyShaderEditor.VertexColorNode;57;-4472.083,636.1151;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;59;-4566.498,401.555;Inherit;True;Property;_TimeScaleoverLifetimeStrength;TimeScale over Lifetime Strength;6;0;Create;True;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;60;-4255.381,578.9849;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;63;-4106.739,572.4466;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;64;-3968.474,619.4706;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.0001;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;62;-3903.166,535.0757;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-4055.801,326.0308;Inherit;False;Property;_TimeScale;TimeScale;5;0;Create;True;0;0;False;0;False;0;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;25;-3472.942,614.7725;Inherit;True;u;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;33;-3496.321,-730.8126;Inherit;False;25;u;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;19;-2748.026,145.8112;Inherit;True;Property;_TextureSample0;Texture Sample 0;1;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;18;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PowerNode;65;-3292.824,909.6128;Inherit;True;True;2;0;FLOAT;0;False;1;FLOAT;0.41;False;1;FLOAT;0
Node;AmplifyShaderEditor.ScaleAndOffsetNode;66;-3060.354,913.6722;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;-0.1;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;34;-3497.251,-643.7655;Inherit;False;14;uv;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;27;-3029.638,767.8401;Inherit;False;Constant;_Float1;Float 1;5;0;Create;True;0;0;False;0;False;16.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;36;-3495.043,-547.1436;Inherit;False;22;Time;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;26;-3184.636,670.3638;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;23;-3178.477,456.8599;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;48;-2138.953,286.1634;Inherit;False;Property;_FlowStrength;FlowStrength;2;0;Create;True;0;0;False;0;False;0;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;24;-2905.431,470.3693;Inherit;True;5;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;54;-1271.291,128.4259;Inherit;True;Property;_TextureSample2;Texture Sample 2;1;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;18;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;2;-1432.82,-357.7129;Inherit;False;Property;_ColorEnd;ColorEnd;4;0;Create;True;0;0;False;0;False;1,0.1372549,0.7803922,1;1,0.1308884,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;1;-1438.535,-547.1029;Inherit;False;Property;_ColorStart;ColorStart;3;0;Create;True;0;0;False;0;False;0,0.3333335,1,1;1,0.8027192,0.3632075,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;6;-910.2878,-88.27178;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;7;-726.9094,-4.718172;Inherit;False;Property;_Emission;Emission;7;0;Create;True;0;0;False;0;False;0;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;9;-418.6801,100.2712;Inherit;False;Property;_UseDarkEdge;UseDarkEdge;8;0;Create;True;0;0;False;0;False;0;1;0;True;;Toggle;2;Key0;Key1;Create;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;18;-3572.658,-204.416;Inherit;True;Property;_MainTex;MainTex;1;0;Create;True;0;0;False;0;False;-1;None;2ef51388c05f48942ae53b2cd6f73d55;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;24;0;13;2
WireConnection;24;1;23;0
WireConnection;24;2;26;0
WireConnection;24;3;66;0
...
ASEEND*/
//CHKSM=592E0C45E9A0E4F23FFB59B6771849D8630B993A