...
Shader "Whl/Fx/Dissolution-shape"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float2 rotator17 = mul( ( i.uv_texcoord.xy + i.uv_texcoord.w ) - _RotationCenter , float2x2( cos17 , -sin17 , sin17 , cos17 )) + _RotationCenter;
			float smoothstepResult34 = smoothstep( ( 1.0 - _Soft ) , _Soft , ( (0.0 + (( staticSwitch42 + distance( rotator17.x , 0.5 ) ) - -1.0) * (1.0 - 0.0) / (2.0 - -1.0)) + 1.03 + ( -2.05 * (0.5 + (i.uv_texcoord.z - 0.0) * (0.65 - 0.5) / (1.0 - 0.0)) ) ));
...
/*ASEBEGIN
Version=18935
242;95;1643;847;4100.239;807.0733;2.59393;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;30;-3332.231,465.0176;Inherit;False;Property;_Rotation;Rotation;8;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;63;-3600.944,242.9364;Inherit;False;0;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TFHCRemapNode;67;-1420.293,706.3413;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0.5;False;4;FLOAT;0.65;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;11;-1241.598,964.6302;Inherit;False;Property;_Soft;Soft;9;0;Create;True;0;0;0;False;0;False;1;0.579;0.51;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1;-594.1856,107.6707;Inherit;True;Property;_TextureSample0;Texture Sample 0;6;0;Create;True;0;0;0;False;0;False;-1;None;89609648b6dd11e46bbb56d663098269;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=52F4703478B33DC18049E6AD00D8CABDEDBB394F