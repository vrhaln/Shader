Shader "Unlit/SpecialFX/Liquid"
{
    Properties
    {
        ...
        _FillAmount("Fill Amount", Range(-1,-0.3)) = 0.0
        [HideInInspector] _WobbleX("WobbleX", Range(-1,0)) = 0.0
        ...
        SubShader
        {
            Tags {"RenderType" = "Custom"  "Queue" = "Transparent-1" "IgnoreProjector" = "True" "IsEmissive" = "true" }
