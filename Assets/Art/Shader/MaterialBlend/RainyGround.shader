...
Shader "ASE/RainyGround"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 lerpResult88 = lerp( float3(0,0,1) , BlendNormals( tex2D( _WaterNormal, ( temp_output_72_0 + temp_output_76_0 ) ).rgb , UnpackNormal( tex2D( _WaterNormal, ( ( temp_output_72_0 * 2.0 ) + ( temp_output_76_0 * -0.5 ) ) ) ) ) , _WaveIntensity);
			...
			float3 PuddleNormal86 = BlendNormals( lerpResult88 , tex2D( _RainDrop, fbuv95 ).rgb );
			float temp_output_7_0_g10 = _BlendContrast;
			float4 tex2DNode43 = tex2D( _Height, WorldUV15 );
			float clampResult6_g10 = clamp( ( ( tex2DNode43.r - 1.0 ) + ( i.vertexColor.b * 2.0 ) ) , 0.0 , 1.0 );
			...
			float BChannelLerp49 = clampResult12_g10;
			float4 lerpResult63 = lerp( tex2D( _NormalMap, WorldUV15 ) , float4( PuddleNormal86 , 0.0 ) , ( 1.0 - BChannelLerp49 ));
			float4 Normal19 = lerpResult63;
			o.Normal = Normal19.rgb;
			float4 tex2DNode1 = tex2D( _Albedo, WorldUV15 );
			float4 lerpResult50 = lerp( tex2DNode1 , _PudlleColor , _PuddleDepth);
			float temp_output_7_0_g11 = _BlendContrast;
			float clampResult6_g11 = clamp( ( ( tex2DNode43.r - 1.0 ) + ( i.vertexColor.r * 2.0 ) ) , 0.0 , 1.0 );
			float lerpResult11_g11 = lerp( ( 0.0 - temp_output_7_0_g11 ) , ( temp_output_7_0_g11 + 1.0 ) , clampResult6_g11);
			float clampResult12_g11 = clamp( lerpResult11_g11 , 0.0 , 1.0 );
			float RChannelLerp47 = clampResult12_g11;
...
/*ASEBEGIN
Version=18500
-1736;155;1340;840;4355.146;1133.125;3.309075;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;10;-4338.519,-1375.217;Inherit;False;Property;_Tilling;Tilling;0;0;Create;True;0;0;False;0;False;1;0.51;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-4522.694,-1280.18;Inherit;False;Property;_POMScale;POMScale;10;0;Create;True;0;0;False;0;False;0;-0.05;-0.5;0.5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;37;-3979.825,-991.5964;Inherit;False;Property;_POMPlane;POMPlane;11;0;Create;True;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;32;-4567.275,-1067.438;Inherit;True;Property;_Height;Height;9;0;Create;True;0;0;False;0;False;None;5370463592e42a24683102fafe4738a7;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.ParallaxOcclusionMappingNode;30;-3513.816,-1260.493;Inherit;False;0;8;False;-1;16;False;-1;6;0.02;0;False;1,1;False;0,0;7;0;FLOAT2;0,0;False;1;SAMPLER2D;;False;2;FLOAT;0.02;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT2;0,0;False;6;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;70;-2084.786,1549.673;Inherit;True;Property;_TextureSample1;Texture Sample 1;15;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Instance;69;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;69;-2089.524,1295.676;Inherit;True;Property;_WaterNormal;WaterNormal;15;0;Create;True;0;0;False;0;False;-1;None;e33c32c49ec0f7d4590ac305c6969c79;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;45;-4378.783,-151.9073;Inherit;False;Property;_BlendContrast;BlendContrast;12;0;Create;True;0;0;False;0;False;0;0.221;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;42;-3865.236,-144.8691;Inherit;False;HeightLerp;-1;;10;906f35bed44319e49ab06a6a458c5346;0;3;4;FLOAT;0;False;1;FLOAT;0;False;7;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;41;-3866.534,-319.0691;Inherit;False;HeightLerp;-1;;9;906f35bed44319e49ab06a6a458c5346;0;3;4;FLOAT;0;False;1;FLOAT;0;False;7;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;40;-3872.492,-481.8019;Inherit;False;HeightLerp;-1;;11;906f35bed44319e49ab06a6a458c5346;0;3;4;FLOAT;0;False;1;FLOAT;0;False;7;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;94;-1488.324,1872.978;Inherit;True;Property;_RainDrop;RainDrop;19;0;Create;True;0;0;False;0;False;-1;None;e256e473e3a591b4293cbe481fb84c53;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;68;-2327.569,-420.2354;Inherit;False;49;BChannelLerp;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-2633.702,-693.0605;Inherit;False;Property;_RoughnessMax;RoughnessMax;6;0;Create;True;0;0;False;0;False;1;0.8;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;3;-2639.129,-590.3386;Inherit;True;Property;_RoughnessMap;RoughnessMap;4;0;Create;True;0;0;False;0;False;-1;None;0e4cba8fb7259994da5fb24135e17477;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;1;-2587.175,-1522.585;Inherit;True;Property;_Albedo;Albedo;1;0;Create;True;0;0;False;0;False;-1;None;fe01ade3f41cf4346ac43c95a90c2bc9;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;52;-2549.885,-1098.581;Inherit;False;Property;_PuddleDepth;PuddleDepth;14;0;Create;True;0;0;False;0;False;0;0.868;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;51;-2554.885,-1302.581;Inherit;False;Property;_PudlleColor;PudlleColor;13;0;Create;True;0;0;False;0;False;0,0,0,0;0.245283,0.2261099,0.2117301,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;2;-2604.062,205.2783;Inherit;True;Property;_NormalMap;NormalMap;2;0;Create;True;0;0;False;0;False;-1;None;3b33f47fd3f6dc148812dccb98b83811;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;63;-2008.411,220.0414;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;5;-2594.874,796.7623;Inherit;True;Property;_AOMap;AOMap;8;0;Create;True;0;0;False;0;False;-1;None;e79b95721fdcc004cae77a7283808982;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;19;-1808.072,221.6754;Inherit;False;Normal;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;29;-269.7891,63.29046;Inherit;False;Constant;_Float0;Float 0;9;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;23;-301.7703,-33.50484;Inherit;False;19;Normal;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;0,0;Float;False;True;-1;2;ASEMaterialInspector;0;0;Standard;ASE/RainyGround;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=0A9BC313E279D3EB0A58550611EAA8FFCEE2070F