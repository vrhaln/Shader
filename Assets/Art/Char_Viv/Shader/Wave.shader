...
Shader "Whl/Viv/Wave"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float2 appendResult10_g6 = (float2(( (temp_output_1_0_g6).x * i.uv_texcoord.xy.x ) , ( i.uv_texcoord.xy.y * (temp_output_1_0_g6).y )));
			float2 temp_output_11_0_g6 = float2( 0,0 );
			float2 panner18_g6 = ( ( (temp_output_11_0_g6).x * _Time.y ) * float2( 1,0 ) + i.uv_texcoord.xy);
			float2 panner19_g6 = ( ( _Time.y * (temp_output_11_0_g6).y ) * float2( 0,1 ) + i.uv_texcoord.xy);
			float2 appendResult24_g6 = (float2((panner18_g6).x , (panner19_g6).y));
			float2 uvs_TexCoord78_g6 = i.uv_texcoord;
			uvs_TexCoord78_g6.xy = i.uv_texcoord.xy * float2( 2,2 );
			float2 temp_output_31_0_g6 = ( uvs_TexCoord78_g6.xy - float2( 1,1 ) );
			...
			float2 break89_g6 = appendResult39_g6;
			float2 appendResult12 = (float2(( i.uv_texcoord.z * 0.1 ) , (-7.0 + (i.uv_texcoord.w - 0.0) * (4.5 - -7.0) / (1.0 - 0.0))));
			float2 temp_output_47_0_g6 = appendResult12;
			float temp_output_50_0_g6 = (temp_output_47_0_g6).y;
			float2 appendResult58_g6 = (float2(( break89_g6.x + (temp_output_47_0_g6).x ) , ( break89_g6.y + temp_output_50_0_g6 )));
			float4 tex2DNode7 = tex2D( _MainTex, tex2D( _NoiseTex, ( ( (tex2D( _Sampler6039, ( appendResult10_g6 + appendResult24_g6 ) )).rg * 1.0 ) + ( _ShiningTiling * appendResult58_g6 ) ) ).rg );
...
/*ASEBEGIN
Version=18935
-1653;38;1599;862;3891.208;1410.185;3.678677;True;True
Node;AmplifyShaderEditor.CommentaryNode;42;-2867.791,-439.1719;Inherit;False;1568.071;534.8583;Radial UV Distortion;7;12;38;11;33;32;5;39;Radial UV Distortion;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;39;-1724.719,-333.799;Inherit;False;RadialUVDistortion2;-1;;6;b11d017adbaad6641aa59450fd648dfb;0;7;60;SAMPLER2D;_Sampler6039;False;1;FLOAT2;1,1;False;11;FLOAT2;0,0;False;65;FLOAT;1;False;68;FLOAT2;1,1;False;47;FLOAT2;1,1;False;29;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;31;-370.428,-117.0573;Inherit;False;Property;_EmissionStr;EmissionStr;6;0;Create;True;0;0;0;False;0;False;1;5;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=33D6303D459075F528E4888732A0AB1E58F0DCA0