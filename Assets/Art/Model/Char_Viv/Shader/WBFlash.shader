...
Shader "Whl/Viv/WBFlash"
{
	Properties
	{
		...
		_RadialTilingOffSet("RadialTilingOffSet", Vector) = (1,1,0,0)
		_RT("RT", 2D) = "white" {}
	...
	SubShader
	{
		...
		uniform float4 _RadialTilingOffSet;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 tex2DNode62 = tex2D( _RT, ( ScreenUV52 + ( ( ScreenUV52 - UVCenter271 ) * distance( ScreenUV52 , UVCenter50 ) * ( Range51 - 0.15 ) ) ) );
			float4 tex2DNode89 = tex2D( _RT, ( ScreenUV52 + ( ( ScreenUV52 - UVCenter271 ) * distance( ScreenUV52 , UVCenter50 ) * ( Range51 - 0.3 ) ) ) );
			float4 tex2DNode100 = tex2D( _RT, ( ScreenUV52 + ( ( ScreenUV52 - UVCenter271 ) * distance( ScreenUV52 , UVCenter50 ) * ( Range51 - 0.6 ) ) ) );
			...
			float2 appendResult109 = (float2(_RadialTilingOffSet.x , _RadialTilingOffSet.y));
			float2 appendResult110 = (float2(_RadialTilingOffSet.z , _RadialTilingOffSet.w));
			float2 RadialMath25 = ( ( appendResult22 * appendResult109 ) + appendResult110 );
			float2 uv_NoiseTex = i.uv_texcoord * _NoiseTex_ST.xy + _NoiseTex_ST.zw;
			c.rgb = ( _MainColor * ( tex2D( _Nosie, RadialMath25 ) * ( tex2DNode62 + tex2DNode89 + tex2DNode100 + tex2DNode2 ) * tex2D( _NoiseTex, uv_NoiseTex ).r ) ).rgb;
			c.a = saturate( ( tex2DNode2.a + ( tex2DNode62.a * 0.75 ) + ( tex2DNode89.a * 0.5 ) + ( tex2DNode100.a * 0.25 ) ) );
			return c;
		}
...
/*ASEBEGIN
Version=18935
356;452;1916;914;2383.09;373.9238;2.346536;True;True
Node;AmplifyShaderEditor.CommentaryNode;12;-1920.805,-1948.629;Inherit;False;2154;626.2493;Radial Math;15;17;15;24;23;22;21;20;19;18;16;14;13;25;44;107;Radial Math;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.Vector2Node;19;-1519.798,-1613.461;Float;False;Property;_RadialCenter;RadialCenter;2;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;37;-2126.789,854.0878;Inherit;False;Property;_Range;Range;8;0;Create;True;0;0;0;False;0;False;0.14;-0.03;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;70;-2504.238,373.833;Inherit;False;Property;_Vector2;Vector 2;10;0;Create;True;0;0;0;False;0;False;0.5,0.5;0.5,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;46;-2523.262,673.8326;Inherit;False;Property;_Vector0;Vector 0;9;0;Create;True;0;0;0;False;0;False;0.5,0.5;0.5,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector4Node;108;-535.5686,-1378.279;Inherit;False;Property;_RadialTilingOffSet;RadialTilingOffSet;3;0;Create;True;0;0;0;False;0;False;1,1,0,0;10,1,0,0.36;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;98;-2224.035,3483.191;Inherit;False;Constant;_Float2;Float 2;15;0;Create;True;0;0;0;False;0;False;0.6;0.8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;75;-2152.289,1817.864;Inherit;False;Constant;_Float0;Float 0;13;0;Create;True;0;0;0;False;0;False;0.15;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;109;-307.5686,-1390.279;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;97;-2247.728,3392.182;Inherit;False;51;Range;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;87;-2194.597,2655.388;Inherit;False;Constant;_Float1;Float 1;14;0;Create;True;0;0;0;False;0;False;0.3;0.4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;110;-312.5686,-1284.279;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;107;-117.7978,-1585.392;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;25;4.618568,-1619.103;Inherit;False;RadialMath;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;105;-991.4054,3016.076;Inherit;False;Constant;_Float5;Float 5;16;0;Create;True;0;0;0;False;0;False;0.25;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;2;-1196.03,266.4423;Inherit;True;Property;_RT;RT;5;0;Create;True;0;0;0;False;0;False;-1;816d219bba243c44aa24402307a7f3e4;816d219bba243c44aa24402307a7f3e4;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;89;-1261.471,1951.976;Inherit;True;Property;_TextureSample1;Texture Sample 1;5;0;Create;True;0;0;0;False;0;False;-1;816d219bba243c44aa24402307a7f3e4;816d219bba243c44aa24402307a7f3e4;True;0;False;white;Auto;False;Instance;2;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;100;-1290.908,2779.78;Inherit;True;Property;_TextureSample2;Texture Sample 2;5;0;Create;True;0;0;0;False;0;False;-1;816d219bba243c44aa24402307a7f3e4;816d219bba243c44aa24402307a7f3e4;True;0;False;white;Auto;False;Instance;2;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;27;-1490.453,-368.5603;Inherit;False;25;RadialMath;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;62;-1219.163,1114.452;Inherit;True;Property;_TextureSample0;Texture Sample 0;5;0;Create;True;0;0;0;False;0;False;-1;816d219bba243c44aa24402307a7f3e4;816d219bba243c44aa24402307a7f3e4;True;0;False;white;Auto;False;Instance;2;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;26;-1223.293,-391.6197;Inherit;True;Property;_Nosie;Nosie;1;0;Create;True;0;0;0;False;0;False;-1;None;a1489e09c59a5c44797bedf50264d64c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;74;-329.3815,977.9596;Inherit;True;4;4;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;47;-1223.788,-88.22425;Inherit;True;Property;_NoiseTex;NoiseTex;11;0;Create;True;0;0;0;False;0;False;-1;None;398e4e6b30b1eac45a3a8322d2e3dae8;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;112;-57.11295,-61.61465;Inherit;False;Property;_MainColor;MainColor;0;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;7.999999,7.999999,7.999999,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;28;-72.57673,151.3179;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;113;409.7777,124.049;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;8;-1858.614,-1126.882;Inherit;False;Property;_CullMode;CullMode;6;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.CullMode;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;9;-1862.093,-1029.128;Inherit;False;Property;_ZTestMode;ZTestMode;7;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.CompareFunction;True;0;False;8;8;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;111;217.9801,455.285;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;735.9091,188.4781;Float;False;True;-1;2;ASEMaterialInspector;0;0;CustomLighting;Whl/Viv/WBFlash;False;False;False;False;True;True;True;True;True;True;True;True;False;False;True;False;False;False;False;False;False;Back;2;False;-1;7;True;9;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;False;0;True;Custom;;Transparent;All;18;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;4;-1;-1;-1;0;False;0;0;True;8;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;28;2;47;1
WireConnection;113;0;112;0
WireConnection;113;1;28;0
WireConnection;78;0;77;0
WireConnection;0;9;78;0
WireConnection;0;13;113;0
ASEEND*/
//CHKSM=0A8DE0CB95184FC4DA8C3E0DF00A102A8B592671