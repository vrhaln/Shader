...
Shader "Whl/Viv/Shining"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			Input i = s.SurfInput;
			half4 c = 0;
			float2 uvs_TexCoord68 = i.uv_texcoord;
			uvs_TexCoord68.xy = i.uv_texcoord.xy * float2( 1,1 );
			float2 temp_output_60_0 = ( uvs_TexCoord68.xy - float2( 0.5,0.5 ) );
			float2 appendResult71 = (float2(frac( ( atan2( (temp_output_60_0).x , (temp_output_60_0).y ) / 6.28318548202515 ) ) , length( temp_output_60_0 )));
			float2 appendResult12 = (float2(i.uv_texcoord.z , i.uv_texcoord.w));
			float4 tex2DNode7 = tex2D( _MainTex, tex2D( _NoiseTex, ( ( appendResult71 * _ShiningTiling ) + appendResult12 ) ).rg );
...
/*ASEBEGIN
Version=18935
-2393;312;1916;956;3696.448;1224.918;2.071118;True;True
Node;AmplifyShaderEditor.CommentaryNode;59;-2862.511,-1180.467;Inherit;False;1692;591.2493;;12;71;70;69;68;67;66;65;64;63;62;61;60;Radial Math;1,1,1,1;0;0
Node;AmplifyShaderEditor.Vector2Node;69;-2813.17,-1059.146;Float;False;Constant;_Vector3;Vector 3;0;0;Create;True;0;0;0;False;0;False;1,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TextureCoordinatesNode;68;-2646.474,-1095.331;Inherit;True;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;66;-2645.505,-783.299;Float;False;Constant;_Vector2;Vector 2;0;0;Create;True;0;0;0;False;0;False;0.5,0.5;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleSubtractOpNode;60;-2387.019,-982.7185;Inherit;True;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ComponentMaskNode;62;-2094.511,-1036.467;Inherit;False;False;True;True;True;1;0;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;63;-2094.511,-1116.467;Inherit;False;True;False;True;True;1;0;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TauNode;65;-1845.16,-1002.972;Inherit;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.ATan2OpNode;70;-1849.972,-1117.488;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;67;-1686.341,-1114.311;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LengthOpNode;64;-1856.698,-775.673;Inherit;True;1;0;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FractNode;61;-1549.118,-1068.356;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;42;-2867.791,-439.1719;Inherit;False;1568.071;534.8583;Radial UV Distortion;9;12;38;11;33;32;5;56;58;72;Radial UV Distortion;1,1,1,1;0;0
Node;AmplifyShaderEditor.DynamicAppendNode;71;-1580.589,-809.8456;Inherit;True;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;11;-2822.791,-329.3742;Inherit;False;0;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;72;-1548.896,-402.3123;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleAddOpNode;73;-1378.667,-340.144;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;7;-749.3533,-370.6358;Inherit;True;Property;_MainTex;MainTex;1;0;Create;True;0;0;0;False;0;False;-1;f9f85f52c5ad25c48955458e0c2ad9a8;265ca3fed69abfd478b7640e0f4f20ca;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;31;-370.428,-117.0573;Inherit;False;Property;_EmissionStr;EmissionStr;6;0;Create;True;0;0;0;False;0;False;1;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;58;-1690.003,-108.6103;Inherit;False;RadialUVDistortion2;-1;;2;;0;0;0
...
Node;AmplifyShaderEditor.FunctionNode;56;-1698.32,-31.36785;Inherit;False;RadialUVDistortion_2;-1;;2;a78fd7a8cedce2f4f8c7632d68edfc1f;0;7;60;SAMPLER2D;0.0;False;1;FLOAT2;1,1;False;11;FLOAT2;0,0;False;65;FLOAT;1;False;68;FLOAT2;1,1;False;47;FLOAT2;1,1;False;29;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;-2294.14,-273.7598;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.1;False;1;FLOAT;0
...
WireConnection;73;1;12;0
WireConnection;6;1;73;0
...
ASEEND*/
//CHKSM=EB21B081FD4CF6BA02BDFF555C8DC28D2E632CF7