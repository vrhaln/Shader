...
/*ASEBEGIN
Version=18935
-1170;10;1233;875;2521.631;1241.716;5.236115;True;True
...
Node;AmplifyShaderEditor.Vector2Node;249;-225.8737,1912.539;Inherit;False;Property;_NormalSpeed;NormalSpeed;10;0;Create;True;0;0;0;False;0;False;0,0;-4,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;247;53.55202,1797.927;Inherit;False;Property;_NormalScale;NormalScale;9;0;Create;True;0;0;0;False;0;False;1;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;252;-166.8737,2138.539;Inherit;False;Property;_TimeSpeed;TimeSpeed;16;0;Create;True;0;0;0;False;0;False;1;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;414;-234.7977,6833.247;Inherit;False;Property;_NoiseSpeed;Noise Speed;29;0;Create;True;0;0;0;False;0;False;1;0.005;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;259;262.6466,2176.107;Inherit;False;Constant;_Float2;Float2;11;0;Create;True;0;0;0;False;0;False;1;-0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;359;-194.0279,6362.452;Inherit;False;Property;_FoamRange;Foam Range;27;0;Create;True;0;0;0;False;0;False;0;2.32;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;418;264.5443,7382.462;Inherit;False;Property;_FoamNoiseSize2;FoamNoise Size2;34;0;Create;True;0;0;0;False;0;False;0,0;50,50;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;382;266.1846,7017.138;Inherit;False;Property;_FoamNoiseSize;FoamNoise Size;33;0;Create;True;0;0;0;False;0;False;0,0;80,100;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SamplerNode;255;842.1161,2009.69;Inherit;True;Global;NormalMap;NormalMap;8;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;bump;Auto;True;Instance;253;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;369;232.3647,6582.167;Inherit;False;Property;_FoamFrequency;Foam Frequency;30;0;Create;True;0;0;0;False;0;False;0;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;365;78.28913,6714.943;Inherit;False;Property;_FoamSpeed;Foam Speed;28;0;Create;True;0;0;0;False;0;False;1;3.38;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector4Node;190;-188.1175,8382.523;Inherit;False;Property;_WaveASpeedXYSteepnesswavelength;WaveA(SpeedXY,Steepness,wavelength);37;0;Create;True;0;0;0;False;0;False;1,1,2,50;0,1,5,50;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CustomExpressionNode;188;213.0561,8281.253;Inherit;False;float steepness = wave.z * 0.01@$float wavelength = wave.w@$float k = 2 * UNITY_PI / wavelength@$float c = sqrt(9.8 / k)@$float2 d = normalize(wave.xy)@$float f = k * (dot(d, position.xz) - c * _Time.y)@$float a = steepness / k@$			$$tangent += float3($-d.x * d.x * (steepness * sin(f)),$d.x * (steepness * cos(f)),$-d.x * d.y * (steepness * sin(f))$)@$$binormal += float3($-d.x * d.y * (steepness * sin(f)),$d.y * (steepness * cos(f)),$-d.y * d.y * (steepness * sin(f))$)@$$return float3($d.x * (a * cos(f)),$a * sin(f),$d.y * (a * cos(f))$)@;3;Create;4;True;position;FLOAT3;0,0,0;In;;Inherit;False;True;tangent;FLOAT3;1,0,0;InOut;;Inherit;False;True;binormal;FLOAT3;0,0,1;InOut;;Inherit;False;True;wave;FLOAT4;0,0,0,0;In;;Inherit;False;GerstnerWave;True;False;0;;False;4;0;FLOAT3;0,0,0;False;1;FLOAT3;1,0,0;False;2;FLOAT3;0,0,1;False;3;FLOAT4;0,0,0,0;False;3;FLOAT3;0;FLOAT3;2;FLOAT3;3
...
Node;AmplifyShaderEditor.Vector4Node;202;225.1112,8454.948;Inherit;False;Property;_WaveB;WaveB;38;0;Create;True;0;0;0;False;0;False;1,1,2,50;0.5,1,3,20;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;286;-206.8185,3740.201;Inherit;False;Property;_UnderWaterDistort;UnderWaterDistort;15;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CustomExpressionNode;196;549.0386,8281.34;Inherit;False;float steepness = wave.z * 0.01@$float wavelength = wave.w@$float k = 2 * UNITY_PI / wavelength@$float c = sqrt(9.8 / k)@$float2 d = normalize(wave.xy)@$float f = k * (dot(d, position.xz) - c * _Time.y)@$float a = steepness / k@$			$$tangent += float3($-d.x * d.x * (steepness * sin(f)),$d.x * (steepness * cos(f)),$-d.x * d.y * (steepness * sin(f))$)@$$binormal += float3($-d.x * d.y * (steepness * sin(f)),$d.y * (steepness * cos(f)),$-d.y * d.y * (steepness * sin(f))$)@$$return float3($d.x * (a * cos(f)),$a * sin(f),$d.y * (a * cos(f))$)@;3;Create;4;True;position;FLOAT3;0,0,0;In;;Inherit;False;True;tangent;FLOAT3;1,0,0;InOut;;Inherit;False;True;binormal;FLOAT3;0,0,1;InOut;;Inherit;False;True;wave;FLOAT4;0,0,0,0;In;;Inherit;False;GerstnerWave;True;False;0;;False;4;0;FLOAT3;0,0,0;False;1;FLOAT3;1,0,0;False;2;FLOAT3;0,0,1;False;3;FLOAT4;0,0,0,0;False;3;FLOAT3;0;FLOAT3;2;FLOAT3;3
Node;AmplifyShaderEditor.RangedFloatNode;287;-157.8185,3827.201;Inherit;False;Constant;_Float4;Float 4;15;0;Create;True;0;0;0;False;0;False;0.01;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector4Node;204;643.9191,8471.736;Inherit;False;Property;_WaveC;WaveC;39;0;Create;True;0;0;0;False;0;False;1,1,2,50;-20,-20,1,10;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;229;-73.18737,1054.709;Inherit;False;Property;_DeepRange;DeepRange;5;0;Create;True;0;0;0;False;0;False;1;0.37;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.CustomExpressionNode;203;889.371,8256.53;Inherit;False;float steepness = wave.z * 0.01@$float wavelength = wave.w@$float k = 2 * UNITY_PI / wavelength@$float c = sqrt(9.8 / k)@$float2 d = normalize(wave.xy)@$float f = k * (dot(d, position.xz) - c * _Time.y)@$float a = steepness / k@$			$$tangent += float3($-d.x * d.x * (steepness * sin(f)),$d.x * (steepness * cos(f)),$-d.x * d.y * (steepness * sin(f))$)@$$binormal += float3($-d.x * d.y * (steepness * sin(f)),$d.y * (steepness * cos(f)),$-d.y * d.y * (steepness * sin(f))$)@$$return float3($d.x * (a * cos(f)),$a * sin(f),$d.y * (a * cos(f))$)@;3;Create;4;True;position;FLOAT3;0,0,0;In;;Inherit;False;True;tangent;FLOAT3;1,0,0;InOut;;Inherit;False;True;binormal;FLOAT3;0,0,1;InOut;;Inherit;False;True;wave;FLOAT4;0,0,0,0;In;;Inherit;False;GerstnerWave;True;False;0;;False;4;0;FLOAT3;0,0,0;False;1;FLOAT3;1,0,0;False;2;FLOAT3;0,0,1;False;3;FLOAT4;0,0,0,0;False;3;FLOAT3;0;FLOAT3;2;FLOAT3;3
Node;AmplifyShaderEditor.RangedFloatNode;270;-208.0243,2740.764;Inherit;False;Property;_ReflectDistort;ReflectDistort;14;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;280;-186.511,2823.656;Inherit;False;Constant;_Float3;Float 3;15;0;Create;True;0;0;0;False;0;False;0.01;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;372;592.7315,6145.298;Inherit;False;Property;_FoamBlend;Foam Blend;35;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;385;1147.706,6794.566;Inherit;False;Property;_FoamDissolve;FoamDissolve;32;0;Create;True;0;0;0;False;0;False;0;1.67;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;297;332.8408,3036.239;Inherit;False;Property;_ReflectPower;Reflect Power;13;0;Create;True;0;0;0;False;0;False;0;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;392;991.7711,6452.836;Inherit;False;Property;_FoamWidth;Foam Width;31;0;Create;True;0;0;0;False;0;False;0;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;296;333.8408,2947.239;Inherit;False;Property;_ReflectIntensity;Reflect Intensity;12;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ScreenColorNode;281;483.0916,3540.469;Inherit;False;Global;_GrabScreen0;Grab Screen 0;15;0;Create;True;0;0;0;False;0;False;Object;-1;False;False;False;False;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;224;86.09047,501.1209;Inherit;False;Property;_DeepColor;DeepColor;4;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0.4978522,0.972549,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;225;87.09047,693.1208;Inherit;False;Property;_ShallowColor;ShallowColor;3;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0.9431779,1,0.5019608;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;335;-45.14925,5120.727;Inherit;False;Property;_ShoreRange;Shore Range;23;0;Create;True;0;0;0;False;0;False;1;1.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;239;337.997,1274.051;Inherit;False;Property;_FresnelPower;FresnelPower;7;0;Create;True;0;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;263;650.2175,2521.863;Inherit;True;Property;_ReflectionTex;ReflectionTex;11;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;341;55.18487,5374.089;Inherit;False;Property;_ShoreColor;ShoreColor;22;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,0.9606918,0.9292453,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;237;586.8942,954.5559;Inherit;False;Property;_FresnelColor;FresnelColor;6;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.3607843,0.6039216,0.9921569,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;211;1604.111,8377.38;Inherit;False;Property;_WaveColor;WaveColor;36;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.1270915,0.1838478,0.2264151,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;395;1693.684,6447.207;Inherit;False;Property;_FoamColor;FoamColor;26;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;350;582.8604,5175.859;Inherit;False;Property;_ShoreEdgeWidth;Shore Edge Width;24;0;Create;True;0;0;0;False;0;False;0;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;353;1064.86,5248.859;Inherit;False;Property;_ShoreEdgeIntensity;Shore Edge Intensity;25;0;Create;True;0;0;0;False;0;False;0;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;407;2220.885,445.4521;Inherit;False;Property;_FogDistanceEnd;Fog Distance End;1;0;Create;True;0;0;0;False;0;False;700;85;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;409;2221.153,342.4093;Inherit;False;Property;_FogDistanceStart;Fog Distance Start;0;0;Create;True;0;0;0;False;0;False;0;15;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TransformDirectionNode;199;1608.579,8562.13;Inherit;False;World;Object;False;Fast;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.NormalizeNode;198;1423.579,8563.131;Inherit;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SamplerNode;312;673.8708,4208.549;Inherit;True;Property;_CausticsTex;CausticsTex;17;0;Create;True;0;0;0;False;0;False;-1;None;72417ee6f632e4e4aabc8c81143957bf;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;325;672.845,4454.505;Inherit;True;Property;_TextureSample0;Texture Sample 0;19;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;312;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;304;0.9738665,4195.776;Inherit;False;Property;_CausticsScale;Caustics Scale;18;0;Create;True;0;0;0;False;0;False;0;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;311;-114.2406,4328.118;Inherit;False;Property;_CausticsSpeed;Caustics Speed;19;0;Create;True;0;0;0;False;0;False;-8,0;-8,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;314;985.8496,4407.782;Inherit;False;Property;_CausticsIntensity;Caustics Intensity;20;0;Create;True;0;0;0;False;0;False;0;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;321;538.0593,4751.953;Inherit;False;Property;_CausticsRange;Caustics Range;21;0;Create;True;0;0;0;False;0;False;0;20;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;310;-10.28927,4533.285;Inherit;False;Constant;_Float5;Float 5;19;0;Create;True;0;0;0;False;0;False;0.01;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;4785.291,1647.043;Float;False;True;-1;2;ASEMaterialInspector;0;0;Unlit;ASE/Toon_InteractiveWater;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;True;0;True;Custom;;Transparent;All;18;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Absolute;0;;2;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=6F6394FA4B6EBEF2E1A5B3F568F621C360E5A921