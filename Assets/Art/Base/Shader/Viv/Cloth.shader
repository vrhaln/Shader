...
Shader "Whl/Viv/Cloth"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#ifdef UNITY_PASS_FORWARDBASE
				float3 staticSwitch98 = temp_cast_0;
			#else
			...
			float4 FinalBaseColor127 = ( ( float4( LightColor99 , 0.0 ) * ( saturate( lerpBlendMode116 )) ) + float4( ReflectColor152 , 0.0 ) + EmissionColor174 + ( MatCap85 * _MatCapIntensity ) );
...
/*ASEBEGIN
Version=18935
-1538;45;1312;896;7906.975;-419.1656;2.921985;True;True
...
Node;AmplifyShaderEditor.ColorNode;48;-5056.21,-1350.313;Inherit;False;Property;_IORColor;IORColor;19;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;0.07564969,0.2191233,0.6415094,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;211;-5555.074,-378.1028;Inherit;False;Property;_InnerEmissStr;InnerEmissStr;16;0;Create;True;0;0;0;False;0;False;0.1,2;0.1,2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;206;-5395.073,117.5082;Inherit;False;Property;_FreStr;FreStr;17;0;Create;True;0;0;0;False;0;False;1;0.74;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;124;-6740.394,1077.223;Inherit;False;99;LightColor;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;45;-3000.886,3106.521;Inherit;False;Property;_Opacity;Opacity;3;0;Create;True;0;0;0;False;0;False;1;0.931;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;121;-6754.249,2167.145;Inherit;False;85;MatCap;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;119;-6740.659,2373.781;Inherit;False;Property;_MatCapIntensity;MatCapIntensity;28;0;Create;True;0;0;0;False;0;False;1;1.49;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;126;-6409.964,1380.274;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;123;-6510.462,2179.405;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;120;-5797.282,1436.337;Inherit;True;4;4;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=248C3F9764A263ADBB0D241527988D70F8947CBD