	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float4 appendResult15 = (float4((( (_MainColor).rgb * saturate( fresnelNode17 ) )).xyz , _Opacity));
...
/*ASEBEGIN
Version=18100
-1401;217;1562;893;1975.46;506.7852;1.3;True;False
Node;AmplifyShaderEditor.RangedFloatNode;19;-1559.722,306.8603;Inherit;False;Property;_FrePower;FrePower;3;0;Create;True;0;0;False;0;False;5;1.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-1566.97,212.2869;Inherit;False;Property;_FreScale;FreScale;2;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FresnelNode;17;-1330.241,174.4638;Inherit;True;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;34;-965.6601,170.7742;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=726012C850BE7ED89DE5D57E5365678AB939E130