...
//创建一个GUI类
public class CommonGUI5 : ShaderGUI
{
 ...
 //   MaterialProperty MainAlphaPower = null;
...

    {
        ...
        if (Dissolve_Tex.textureValue != null)
        {
            ...
            _Dissolvexx = Foldouts(_Dissolvexx, "贴图设置");
            ...
            if (material.GetFloat("_IfDissolvePlus") == 1)
            {
                ...
                if (DissloveTexPlus.textureValue != null)
                {
                    ...
                    _Dissolveplusxx = Foldouts(_Dissolveplusxx, "贴图设置");
...

    {
        ...
        if (Distort_Tex.textureValue != null)
        {
            ...
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            _DistortTexxx = Foldouts(_DistortTexxx, "贴图设置");
            ...
            if (DistortMaskTex.textureValue != null)
            {
                ...
                EditorGUILayout.BeginVertical(EditorStyles.helpBox);
                _DistortMaskTexxx = Foldouts(_DistortMaskTexxx, "贴图设置");
...

    {
...

        {
            ...
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            _VTOMaskxx = Foldouts(_VTOMaskxx, "贴图设置");
...

    {
...

        {
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            _AddTexxx = Foldouts(_AddTexxx, "贴图设置");
    ...
    void GUI_CustomLight(Material material)
    {
...

        {
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            _NormalTexxx = Foldouts(_NormalTexxx, "贴图设置");
   ...
   // 
...

    {
        ...
        if (material.GetFloat("_StencilStyle") == 0)
        {
            if (GUILayout.Button("已关闭", shortButtonStyle))
            {
                ...
                material.SetFloat("_Reference", 1);
                material.SetFloat("_Comparison", 8);
                material.SetFloat("_Pass", 2);
                material.SetFloat("_Fail", 0);
            }
        }
        else if (material.GetFloat("_StencilStyle") == 1)

        {
            if (GUILayout.Button("遮罩模板", shortButtonStyle))
            {
                material.SetFloat("_StencilStyle", 2);
                material.SetFloat("_Reference", 0);
                material.SetFloat("_Comparison", 3);
                material.SetFloat("_Pass", 0);
                material.SetFloat("_Fail", 0);
            }
        }
        else if (material.GetFloat("_StencilStyle") == 2)
        {
            if (GUILayout.Button("剔除组模板", shortButtonStyle))
            {
                material.SetFloat("_StencilStyle", 3);
                material.SetFloat("_Reference", 0);
                material.SetFloat("_Comparison", 8);
                material.SetFloat("_Pass", 0);
                material.SetFloat("_Fail", 0);
        ...
        if (material.GetFloat("_StencilStyle") == 3) { 
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
...

    {
        ...
        GUILayout.Label("本shader由油腻联盟坏熊猫制作，特别感谢闻亚洲，Nor_Zed，sion，123木头人，lolming，Allen，苏坤，AmantJy，仲冬，馒头,自赎,Cokey,J迷的帮助与支持", style);
        EditorGUILayout.EndVertical();
